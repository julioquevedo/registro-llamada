<?php
class Model_xencuestar extends CI_Model {
    ...
    public function lista_cli($id_lista) {
        $this->db->join('clientes b','b.id_cliente=a.id_cliente','left');        
        $this->db->from('lista_detalle a');
