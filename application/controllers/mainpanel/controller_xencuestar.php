<?php
class Controller_xencuestar extends CI_Controller {

    private $current_section    ='xencuestar';
    ...
    function __construct() {
        ...
        $this->load->model('mainpanel/Model_xencuestar');
    ...
    public function listado() {
        ...
        // LISTA TRABAJOS
        $listado            = $this->Model_xencuestar->getListaTrabajos();
