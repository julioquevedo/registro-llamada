<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> TRABAJOS PENDIENTES</h2>
                ...
                <?php
                    ...
                    for($i=0; $i<count($listado); $i++)
                    {
                        ...
                        echo '<tr>';
                            ...
                            echo '<a class="btn btn-info" href="mainpanel/xencuestar/'.$id_trabajo.'/lista-cli"> Ingresar</a> ';
