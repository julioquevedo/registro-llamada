...
<ul class="nav nav-tabs nav-stacked main-menu">
    ...
    <li <?php if($current_section=='encuesta'){echo 'class="active"';}?>><a class="ajax-link" href="mainpanel/encuesta/lista"><i class="icon-th"></i><span class="hidden-tablet">Encuestas</span></a></li>          
    ...
    <li <?php if($current_section=='asignaciones'){echo 'class="active"';}?>><a class="ajax-link" href="mainpanel/asignaciones/lista"><i class="icon-th"></i><span class="hidden-tablet">Asignar Encuestas</span></a></li> 
