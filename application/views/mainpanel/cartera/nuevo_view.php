...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/clientes/cartera/grabar" method="post" enctype="multipart/form-data" onsubmit="return valida_clientes()">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls ">
                            ...
                            foreach ($listado_clientes as $key => $value) {
                                ...
                                echo '<input type="checkbox" value="'.$value['id_cliente'].'">'.$value['nombre_comercial'];
                                echo '</div>';
                            }
                            ?>
                            </div>
