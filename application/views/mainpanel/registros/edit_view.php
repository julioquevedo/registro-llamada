            ...
            <form class="form-horizontal" action="mainpanel/registros/actualizar" method="post" enctype="multipart/form-data" >
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="nivel" id="nivel0" value="0" <?php if($registro->nivel=="0") echo ' checked="checked"'; ?>>
                                Administrador
                            </label>
                            <div style="clear:both"></div>
                            <label class="radio">
                                <input type="radio" name="nivel" id="nivel1" value="1" <?php if($registro->nivel=="1") echo ' checked="checked"'; ?>>
                                Jefe de Teleoperador
                            </label>
                            <div style="clear:both"></div>
                            <label class="radio">
                                <input type="radio" name="nivel" id="nivel2" value="2" <?php if($registro->nivel=="2") echo ' checked="checked"'; ?>>
                                Teleoperador
                            </label>                            
                        </div>
                    </div>                     
